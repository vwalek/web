...
csr-8b9nm   40m     system:node:master-1.mycluster.example.com                   Approved,Issued
csr-c6w6n   40m     system:serviceaccount:openshift-machine-config-operator:node-bootstrapper   Approved,Issued
csr-g5fpm   31m     system:node:worker-1.mycluster.example.com                   Approved,Issued
csr-hsmlj   33m     system:serviceaccount:openshift-machine-config-operator:node-bootstrapper   Approved,Issued
csr-j4pct   31m     system:node:worker-0.mycluster.example.com                   Approved,Issued
csr-jkkh7   39m     system:node:master-2.mycluster.example.com                   Approved,Issued
csr-jnc5l   39m     system:node:master-0.mycluster.example.com                   Approved,Issued
...
csr-7sw7b   14s     system:node:worker-a.mycluster.example.com                   Pending
csr-8b9nm   41m     system:node:master-1.mycluster.example.com                   Approved,Issued
csr-c6w6n   41m     system:serviceaccount:openshift-machine-config-operator:node-bootstrapper   Approved,Issued
csr-g5fpm   33m     system:node:worker-1.mycluster.example.com                   Approved,Issued
csr-hsmlj   34m     system:serviceaccount:openshift-machine-config-operator:node-bootstrapper   Approved,Issued
csr-j4pct   33m     system:node:worker-0.mycluster.example.com                   Approved,Issued
csr-jkkh7   41m     system:node:master-2.mycluster.example.com                   Approved,Issued
csr-jnc5l   41m     system:node:master-0.mycluster.example.com                   Approved,Issued
